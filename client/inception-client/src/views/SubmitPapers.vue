    ...
    <div class="max-w-lg w-full bg-gray-900 bg-opacity-80 p-8 rounded-lg shadow-lg">
      ...
      <form @submit.prevent="submitPaper" class="space-y-4">
        <input
          ...
          type="text"
          placeholder="Title"
          class="w-full p-3 bg-transparent border border-nebula rounded focus:outline-none text-star placeholder-opacity-50"
          required
        />
        <textarea
          v-model="description"
        ...
        />
        <input
          v-model="citationRate"
          type="number"
          placeholder="Citation Rate"
          class="w-full p-3 bg-transparent border border-nebula rounded focus:outline-none text-star placeholder-opacity-50"
        />
        ...
        <button
          type="submit"
          class="w-full py-3 mt-4 bg-nebula text-white font-semibold rounded hover:bg-indigo-700 transition duration-300 transform hover:scale-105"
        >
          Submit Paper
        </button>
      </form>
